import requests
import copy
from data import static_api_server, geocode_api_server, places_api_server, format_keys, format_values
...
Http статус: {places_response.status_code} ({places_response.reason})"""
    ...
    def reset_params(self):
        from data import static_params, geocoder_params, places_params
